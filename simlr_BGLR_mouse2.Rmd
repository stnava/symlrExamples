...
image( regs[[1]][1:2500,1:2500], main='Corner of regularization matrix for SNPs.')
bestVarx = 0
nEmbed = 3
for ( k in 1:5 ) { # take best result over multiple initial starting points
  temp = simlr(
    ...
    verbose = TRUE,
    constraint = c( "Stiefel" ), # some effort to keep V orthogonal
    randomSeed = k-1 )
...
cca.with.rgcca = sgcca( # this initializes with SVD
  ...
  c1 = c(0.5,0.5),  # set to match simlr
