...
Noise and signal in simulation data.
...
```{r, echo=FALSE, out.width="100%", fig.cap="Example SiMLR study overview."}
...
```{r, echo=FALSE, out.width="100%", fig.cap="SiMLR simulation study design."}
...
```{r, echo=FALSE, out.width="100%", fig.cap="SiMLR simulation study results: sensitivity to noise and ability to recover signal."}
...
```{r, echo=FALSE, out.width="100%", fig.cap="Mixomics study: supervised survival prediction comparison to RGCCA."}
...
```{r, echo=FALSE, out.width="100%", fig.cap="PTBP fully supervised brain age prediction: comparison to RGCCA."}
