...
print( anova( m1, m2  ) )
mean(abs( demog[haveAllMerge,"AgeAtScan"] - predict(m2)))
...
print( anova( m1, m2  ) )
demog[haveAllMerge,"Income"] = antsrimpute(demog[haveAllMerge,])
...
print( summary(lm( pthk[,1] ~  ( pcbf[,1] + pfa[,1] ) + Sex + BV+ AgeAtScan, data = demog )) )
