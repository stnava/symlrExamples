...
if ( ! exists( "energyType" ) ) energyType = 'regression'
    set.seed(1500)
     ...
     inmats = list( vox = mat1, vox2 = mat2, vox3 = mat3 )
     regs = regularizeSimlr( inmats )
     initu = initializeSimlr( inmats, 2, jointReduction = T, uAlgorithm = 'ica' )
     result = simlr( inmats, smoothingMatrices = regs,
       initialUMatrix = initu , verbose=2, iterations=55, energyType = energyType  )
     ...
     resultp = simlr(list( vox = mat1, vox2 = mat2[s1,], vox3 = mat3[s2,] ),
        ...
        initialUMatrix = initu, verbose=TRUE, iterations=55, energyType = energyType )
