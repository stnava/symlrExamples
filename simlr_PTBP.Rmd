...
if ( ! exists("initu" ) ) initu = initializeSimlr( inmats, 8, jointReduction = T, uAlgorithm = 'random' )
if ( ! exists("inmatsrob")) {
#  inmatsrob=list()
 # for ( k in 1:length( inmats ) ) inmatsrob[[k]] = robustMatrixTransform( inmats[[k]] )
}
if ( ! exists( "eType" ) )  eType = 'regression' # choose this for speed b/c p is large
